...
activities = {
    ...
    "Science Olympiad": {
        ...
        "max_participants": 25,
        "participants": ["nina@mergington.edu", "kevin@mergington.edu", "lucas@mergington.edu"]
    },
    "Painting Club": {
        "description": "Explore various painting techniques and styles",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["sophia@mergington.edu", "claire@mergington.edu"]
    },
    "Theater Production": {
        "description": "Perform in school plays and musicals",
        "schedule": "Tuesdays, Thursdays, and Saturdays, 4:00 PM - 6:00 PM",
        "max_participants": 35,
        "participants": ["jacob@mergington.edu", "isabella@mergington.edu", "aaron@mergington.edu"]
    },
    "Band": {
    ...
    "Choir": {
        "description": "Sing in ensemble performances and concerts",
        "schedule": "Tuesdays and Thursdays, 4:30 PM - 5:30 PM",
        "max_participants": 35,
        "participants": ["grace@mergington.edu", "ethan@mergington.edu", "mia@mergington.edu"]
    }
}
